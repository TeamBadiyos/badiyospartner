...
public class BackgroundAvailabilityService extends Service {
    ...
    public static final String ACTION_START = "com.badiyos.expert.action.START_AVAILABILITY";
    public static final String ACTION_STOP = "com.badiyos.expert.action.STOP_AVAILABILITY";
