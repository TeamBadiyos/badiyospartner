...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "theme-color", content: "#0074E4" },
      { title: "badiyos Expert" },
      { name: "description", content: "badiyos Expert — accept bookings and serve customers on the go." },
      { property: "og:title", content: "badiyos Expert" },
      { property: "og:description", content: "badiyos Expert — accept bookings and serve customers on the go." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "badiyos Expert" },
      { name: "twitter:description", content: "badiyos Expert — accept bookings and serve customers on the go." },
